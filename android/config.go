...
func (c *config) JavaSourceOverlays() string {
	return String(c.productVariables.Sacred.Java_Source_Overlays)
}

func (c *config) JavaSourceOverlayModuleWhitelist() []string {
	return android.SacredConfig.JavaSourceOverlayModuleWhitelist
}
...
func (c *deviceConfig) SpecificCameraParametersLibrary() string {
	return String(c.config.productVariables.Sacred.Specific_camera_parameter_library)
}
